    ...
    var body: some View {
        VStack {
            Text("Contrast")
                .font(.title)
                .padding(.top)
            Text("Contrast (Minimum) (Level AA) which requires a contrast of at least 4.5:1 (or 3:1 for large-scale text) and Contrast (Enhanced) (Level AAA) which requires a contrast of at least 7:1 (or 4.5:1 for large-scale text)")
